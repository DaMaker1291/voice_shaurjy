                ...
                >
                  ...
                  {m.link && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 mt-2 px-4 py-2 text-sm font-mono text-green-400 bg-green-900/20 border border-green-800/30 rounded-xl hover:bg-green-900/40 transition-all active:scale-95"
                    >
