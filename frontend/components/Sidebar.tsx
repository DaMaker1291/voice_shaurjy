    ...
    <>
      ...
      >
        ...
        {interests && interests.length > 0 && (
          <div className="px-4 py-3 border-b border-gray-800/30 bg-gray-900/50">
            <p className="text-[10px] font-mono text-purple-500 uppercase tracking-wider mb-1.5">Profile</p>
            <div className="flex flex-wrap gap-1.5">
              {interests.map((topic, i) => (
                <span key={i} className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-purple-900/30 text-purple-400 border border-purple-800/30">
                  {topic}
                </span>
              ))}
            </div>
